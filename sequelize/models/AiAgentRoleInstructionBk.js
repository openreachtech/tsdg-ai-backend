...
/**
 * AiAgentRoleInstructionBk model
 *
 * The write-once history sink of `AiAgentRoleInstruction`. It carries no mixin and no sink of its
 * own: rows arrive here from the backup mixin on the live model and are never rewritten.
 *
 ...
 *
 * @class AiAgentRoleInstructionBk
 * @extends {BaseAppRenchanModel}
 */
export default class AiAgentRoleInstructionBk extends BaseAppRenchanModel {
  /**
  ...
  static createOptions (sequelizeClient) {
    return {
      ...
      tableName: 'ai_agent_role_instructions_bk',
    }
  }
