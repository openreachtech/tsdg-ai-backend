...
const TABLE_NAME = 'ai_agent_default_instructions_bk'
const COLUMN_NAME = {
...
module.exports = {
  async up (
    ...
    /*
     * The write-once sink holds every generation an instruction has ever had, so the pair of agent
     * and generation marker is what addresses one of them.
     *
