...
/*
 * dev-master duplicate: apply the same tool and binding as the production master in dev / CI.
 *
 ...
 */
module.exports = require('../master/20260926100013-000013-ai_agent_tool_suite.cjs')
